...
- **Default mode**: Replace images flagged as AI-generated by cryptographic or heuristic detection
- **Strict mode**: Additionally replace images where C2PA metadata exists but signature cannot be verified
